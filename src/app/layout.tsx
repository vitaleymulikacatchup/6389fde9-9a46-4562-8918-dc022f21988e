...
export const metadata: Metadata = {
  title: "Gloria - Fine Dining Restaurant",
  description: "Experience exceptional fine dining at Gloria. Award-winning cuisine, impeccable service, and elegant ambiance for unforgettable meals.",
  keywords: "fine dining, restaurant, upscale cuisine, reservations, elegant dining experience",
  openGraph: {
    title: "Gloria - Fine Dining Restaurant",
    description: "Experience exceptional fine dining at Gloria. Award-winning cuisine, impeccable service, and elegant ambiance for unforgettable meals.",
